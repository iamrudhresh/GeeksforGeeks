<h2><a href="https://practice.geeksforgeeks.org/problems/c-2-d-arrays0708/1?page=1&difficulty[]=-2&status[]=unsolved&sortBy=submissions">C++ 2-D Arrays | Set-1</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a 2-d array of integers having&nbsp;<strong>N*N&nbsp;</strong>elements, print the transpose of the array.</span></p>
